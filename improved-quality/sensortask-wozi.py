...
# BMP3xx_Reader (src/asy_bmp3xx_driver.py) doesn't contribute anything here: unlike SCD30/SGP40 it
# owns its own per-sensor config_BMP3XX.cfg file via base_classes.py's SensorReaderConfig, not a
# slice of this system-level config.json - see BACKLOG.md's sensortask-wozi.py integration notes.
