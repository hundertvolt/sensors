...
| ISL29125 | I2C1 | irq_pin=GPIO6 (physical pin 9), **externally pulled up on this board** — confirmed by the project owner directly, which is why `devices/dev.toml` sets `irq_pull_up = false` |
