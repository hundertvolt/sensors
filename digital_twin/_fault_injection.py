...
independent reimplementation like every other file in this package - see digital_twin/README.md
for why the whole package avoids importing tests/machine.py).
