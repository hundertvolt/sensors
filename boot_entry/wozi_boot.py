...
src/sensortask_wozi.py (see that module's own docstring and FINAL_WIRING_PLAN.md's Step 1 refined
plan for why). src/sensortask_wozi.py stays independently testable (import it, call
