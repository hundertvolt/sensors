...
# Neither matrix pass names an SCD30 flag: spending no real SCD30 write is the DEFAULT now, so the
# whole suite can run twice here without touching the write-wear budget.
