...
Asked 2026-09-26; answered the same day as OR59 (1: c), OR60 (2: b, via `machine.mem_backup()`), OR61 (3: b, 1.24.1), OR62 (4: b, corrected by OR64: the broadcast stays, owner-decided) and OR63 (5: b) in PROJECT_AUDIT_PLAN.md 3.2. Answered during the
