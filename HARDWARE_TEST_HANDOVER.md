...
6. Step 9's scripts: ~~G8~~ (covered), ~~G12~~ (done), ~~G3~~ (done), ~~G1~~ and ~~G4~~
   ...
   **W3's 1,024 B comparison and R6/R7 — not run**: each needs a throwaway modified image flashed,
   which this session's permission policy refused (2026-09-25); the owner decides.
