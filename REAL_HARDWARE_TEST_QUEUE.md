...
| **Tests still to write** | G1, G3, G4, G6, G10 | Code first, bench second. G6 is adapt-now-measure-later by decision; G10 waits on the C-side reconciliation (cloud work) |
