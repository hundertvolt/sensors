...
Grouped by what each row *needs*, not by which effort opened it. **28 rows owed.** D1 and D2 are the
...
`tests_hardware/README.md`). F1 needs one careful invocation, not a suite run.
