...
| W3 | `test_the_largest_body_any_schema_can_produce_still_fits_under_the_cap` | **DONE 2026-09-19: PASS.** The 1132 B schema maximum still fits, and the 1025-char `NTP_Host` is answered `Invalid` with nothing written | DONE |
