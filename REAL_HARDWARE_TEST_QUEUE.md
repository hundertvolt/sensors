...
| W8 | **Confirm the committed limit of 6** (image E6′ = the tip), ~15 min: identical to E6, then clean under peak load without instrumentation (2 boots) — `REAL_HARDWARE_HANDOVER_LIMIT_6.md` | OPEN |
